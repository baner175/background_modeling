...
dat <- read.csv('Data/histogram_data_cat2.csv', header = TRUE)
...
#                lower = 0.005, upper = 10)$par) # TOOK TOO LONG TO RUN,USING THE SAME VALUE AS CAT0
