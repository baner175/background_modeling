...
J_hat_wbkg <- integrate(function(t) (t^2)*qb_wbkg(t), l, u)$value -
  integrate(function(t) t*qb_wbkg(t), l, u)$value^2
...
signal_search <- function(lambda){
  ...
  J_hat <- integrate(function(t) (t^2)*qb(t), l, u)$value - 
    integrate(function(t) t*qb(t), l, u)$value^2
  
  sig_theta0_hat <- sqrt(
    var_S2_F_hat + (V_hat/(J_hat^2))*mean(sapply(phys_data, d_S2))^2 + 
      (2/J_hat)*mean(sapply(phys_data, d_S2))*
      mean(S2_phys_vec*sapply(phys_data, function(x){x - x_qb_int}))
  )
